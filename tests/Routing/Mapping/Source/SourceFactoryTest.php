...
namespace Jgut\Slim\Routing\Tests\Mapping\Source;
...
/**
 * Mapping source factory tests.
 */
class SourceFactoryTest extends TestCase
{
    /**
     * @expectedException \InvalidArgumentException
     * @expectedExceptionMessageRegExp /^".+" routing source. Must be a SourceInterface, or a directory or file path$/
     */
